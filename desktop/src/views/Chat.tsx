...
const TOOL_TEXT: Record<string, { pending: string; done: string }> = {
  ...
  ideas_view: { pending: 'Viewing ideas', done: 'Viewed ideas' },
  ideas_add: { pending: 'Adding idea', done: 'Added idea' },
  ideas_update: { pending: 'Updating idea', done: 'Updated idea' },
  ideas_create_plan: { pending: 'Creating plan', done: 'Created plan' },
...
const TOOL_ICONS: Record<string, LucideIcon> = {
  ...
  ideas_view: LayoutGrid, ideas_add: LayoutGrid,
  ideas_update: LayoutGrid, ideas_create_plan: LayoutGrid,
